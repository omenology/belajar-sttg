...
if($button) { ?>
	<form action="<?php echo BASE_URL."app/module/nilai/nilai_masuk.php" ?>" method="post">
		...
		<input type="number" name="nilai_rata_tugas" value="<?php if($button == "tilai"){ echo $nilaiTugas; }elseif($button == "edit"){ echo $nilai_rata_tugas; } ?>" readonly>
		<input type="number" name="absen" value="<?php if($button == "tilai"){ echo $nilaiAbsen; }elseif($button == "edit"){ echo $nilai_rata_absen; } ?>" readonly>
